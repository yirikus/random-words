...
VOCAB.VERB_DRUNK = [
    ...
    "a začal[$1$] [VERB_INF]",
    "a kousnul[$1$] se do jazyku. Zakrvácel[$1$] cel[_F_4] [FURNITURE_F_4] ",
    "a kousnul[$1$] se do jazyku. Zakrvácel[$1$] celý [FURNITURE_M_4] ",
    "a kousnul[$1$] se do jazyku. Zakrvácel[$1$] cel[_S_4] [FURNITURE_S_4] ",
